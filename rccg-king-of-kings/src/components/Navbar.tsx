...
const Navbar = () => {
  ...
  return (
    <nav className="bg-primary text-white shadow-lg w-full overflow-x-hidden">
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden bg-primary w-full absolute top-16 z-50 transition-all duration-300 transform ${
