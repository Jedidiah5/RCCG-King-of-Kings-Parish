    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            <p className="text-gray-600">Add your church's address here</p>
            <p className="text-gray-600">Phone: Add phone number here</p>
            <p className="text-gray-600">Email: Add email address here</p>
          </div>
        </div>
      </div>
    </div>
